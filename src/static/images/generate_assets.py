...
def draw_goldfinch_logo(size=512):
    ...
    draw.line([(int(0.64 * w), int(0.72 * h)), (int(0.80 * w), int(0.85 * h))], fill=(255, 255, 255, 200), width=int(8 * scale))
    ...
    draw.line([(int(0.23 * w), int(0.29 * h)), (int(0.12 * w), int(0.31 * h))], fill=(210, 190, 170, 255), width=int(2 * scale))
    ...
    ir = int(13 * scale)
    draw.ellipse([eye_x - ir, eye_y - ir, eye_x + ir, eye_y + ir], fill=(15, 17, 19, 255))
    hr = int(5 * scale)
    draw.ellipse([eye_x - hr + int(2*scale), eye_y - hr - int(2*scale), eye_x + hr + int(2*scale), eye_y + hr - int(2*scale)], fill=(255, 255, 255, 255))
